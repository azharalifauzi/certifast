...
* @returns {Uint8Array}
*/
__exports.print_many_certificate = function(texts, certif_template, callback) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.print_many_certificate(retptr, addBorrowedObject(texts), addBorrowedObject(certif_template), addHeapObject(callback));
...
* @returns {Uint8Array}
*/
__exports.print_certificate = function(text, certif_template, font_fam, x, y, font_size, color) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        var ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        var ptr1 = passStringToWasm0(font_fam, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len1 = WASM_VECTOR_LEN;
        var ptr2 = passArray8ToWasm0(color, wasm.__wbindgen_malloc);
        var len2 = WASM_VECTOR_LEN;
        wasm.print_certificate(retptr, ptr0, len0, addBorrowedObject(certif_template), ptr1, len1, x, y, font_size, ptr2, len2);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
...
* @returns {(Uint8Array)[]}
*/
__exports.print_many_certificate_without_zip = function(texts, certif_template, callback) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.print_many_certificate_without_zip(retptr, addBorrowedObject(texts), addBorrowedObject(certif_template), addHeapObject(callback));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
...
async function init(input) {
    ...
    imports.wbg.__wbg_log_777bc3a6a63cfc21 = function(arg0, arg1) {
